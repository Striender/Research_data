#!/usr/bin/env python3
"""Extract prefetch-origin line-reuse histograms into an Excel workbook."""
...
DEFAULT_OUTPUT_FILE = "../Excel_Output/aiml_bingo/prefetch_line_reuse_count.xlsx"
CACHE_LEVELS = ("L1D", "L2C", "LLC")
SHEET_NAMES = {"L1D": "L1D", "L2C": "L2", "LLC": "LLC"}
DEFAULT_WAYS = {"L1D": 30, "L2C": 10, "LLC": 1}
HISTOGRAM_LABEL = "PREFETCH LINE REUSE COUNT"
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract PREFETCH LINE REUSE COUNT histograms from ChampSim output files."
    )
